...
<div class="results result-well well">
    <?php
...
<form class="restart-assessment" method="post" action="<?php echo htmlentities($_SERVER["PHP_SELF"]); ?>">
    <input type="hidden" name="restart" value=""/>
    <button class="btn">Restart Assessment</button>
</form>
